...
#include(assets/labs/lab_models/sections/1_staticanalysis.md)
#include(assets/labs/lab_models/sections/2_beammodels.md)
#include(assets/labs/lab_models/sections/3_volumemodel.md)
#include(assets/labs/lab_models/sections/4_comparison.md)
